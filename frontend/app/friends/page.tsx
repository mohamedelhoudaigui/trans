...
// --- NEW --- Import the useAuth hook to get the logged-in user's info
...
export default function Home() {
  // --- NEW --- Get authentication status from our global context
  ...
  // --- NEW --- State to track which user is being added to show a loading indicator
  const [isAdding, setIsAdding] = useState<number | null>(null);

  // The useEffect to fetch the list of all users remains the same
  useEffect(() => {
  ...
  // --- NEW --- Handler function for adding a friend
  const handleAddFriend = async (friendId: number) => {
    // --- TIP: Defensive Programming ---
    // Always check for required data before making an API call.
